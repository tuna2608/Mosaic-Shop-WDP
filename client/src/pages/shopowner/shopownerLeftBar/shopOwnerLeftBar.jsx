    ...
    <div className="leftBar">
      <div className="container">
        ...
        <div className="menu">
          ...
          <NavLink className="links-style" to="/ShopOwnerProductList">
            <div className="item">
              <Inventory2OutlinedIcon />
              <span>Sản Phẩm</span>
            </div>
          </NavLink>
          <NavLink className="links-style" to="/ShopOwnerOrderList">
            <div className="item">
...
export default ShopOwnerLeftBar